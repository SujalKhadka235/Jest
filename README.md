...
This API provides functionality for managing users, books, authors, and reviews in a library system. Below is the documentation for all the available routes.
...
- **Request Body**:
  ...
  ```
- **Responses**:
  - `201`: Book review created successfully.
  - `400`: Validation error.
  - `401`: Unauthorized.
...
- **Responses**:
  - `200`: A list of reviews for the book.
  - `404`: Book not found.
...
- **Description**: Create a review for an author.
- **Security**: Requires a valid JWT token.
- **Request Body**:
  ```json
  {
  ...
  ```
- **Responses**:
  - `201`: Author review created successfully.
  - `400`: Validation error.
  - `401`: Unauthorized.
...
- **Responses**:
  - `200`: A list of reviews for the author.
