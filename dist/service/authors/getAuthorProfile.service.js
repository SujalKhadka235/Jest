...
export const getAuthorProfileService = async (author_id) => {
    ...
    const averageRating = authorReviews.length > 0
        ? Math.ceil(authorReviews.reduce((sum, review) => sum + review.rating, 0) /
